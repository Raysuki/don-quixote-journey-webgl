...
var ASM_CONSTS = {
  4860096: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4860157: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4860221: function() {return Module.webglContextAttributes.powerPreference;},  
 4860279: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4860334: function($0) {performance.now = function() { return $0; };},  
 4860382: function($0) {performance.now = function() { return $0; };},  
 4860430: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _PlayKit_GetLocalStorage(key) {
  ...
  function _PlayKit_HasLocalStorageKey(key) {
      var keyStr = UTF8ToString(key);
      try {
  ...
  function _PlayKit_RemoveLocalStorage(key) {
      var keyStr = UTF8ToString(key);
      try {
  ...
  function _PlayKit_SetLocalStorage(key, value) {
      var keyStr = UTF8ToString(key);
...
var asmLibraryArg = {
  ...
  "PlayKit_GetLocalStorage": _PlayKit_GetLocalStorage,
  "PlayKit_HasLocalStorageKey": _PlayKit_HasLocalStorageKey,
  "PlayKit_RemoveLocalStorage": _PlayKit_RemoveLocalStorage,
  "PlayKit_SetLocalStorage": _PlayKit_SetLocalStorage,
